...
import { InfoUserDto } from '../models/info-user-dto';
...
class UserControllerService extends __BaseService {
   ...
   * - `body.surname`:
   *
   * - `body.seansDto.seatCount`:
   *
   * - `body.seansDto.rowNumber`:
   *
   * - `body.seansDto.roomNumber`:
   *
   * - `body.seansDto.id`:
   *
   * - `body.roles`:
   ...
   * - `body.name`:
   *
   * - `body.loyaltyCardDto.price`:
   *
   * - `body.loyaltyCardDto.maxTicket`:
   *
   * - `body.loyaltyCardDto.id`:
   *
   * - `body.loyaltyCardDto.expirationDate`:
   *
   * - `body.loyaltyCardDto.discount`:
   *
   * - `body.id`:
   *
   * - `body.email`:
   ...
   * @return OK
   */
  addUsingPOST2Response(params: UserControllerService.AddUsingPOST2Params): __Observable<__StrictHttpResponse<InfoUserDto>> {
    ...
    if (params.bodyUsername != null) __params = __params.set('body.username', params.bodyUsername.toString());
    if (params.bodySurname != null) __params = __params.set('body.surname', params.bodySurname.toString());
    if (params.bodySeansDtoSeatCount != null) __params = __params.set('body.seansDto.seatCount', params.bodySeansDtoSeatCount.toString());
    if (params.bodySeansDtoRowNumber != null) __params = __params.set('body.seansDto.rowNumber', params.bodySeansDtoRowNumber.toString());
    if (params.bodySeansDtoRoomNumber != null) __params = __params.set('body.seansDto.roomNumber', params.bodySeansDtoRoomNumber.toString());
    if (params.bodySeansDtoId != null) __params = __params.set('body.seansDto.id', params.bodySeansDtoId.toString());
    (params.bodyRoles || []).forEach(val => {if (val != null) __params = __params.append('body.roles', val.toString())});
    if (params.bodyReviewDtoId != null) __params = __params.set('body.reviewDto.id', params.bodyReviewDtoId.toString());
    if (params.bodyPasswordConfirmation != null) __params = __params.set('body.passwordConfirmation', params.bodyPasswordConfirmation.toString());
    if (params.bodyPassword != null) __params = __params.set('body.password', params.bodyPassword.toString());
    if (params.bodyName != null) __params = __params.set('body.name', params.bodyName.toString());
    if (params.bodyLoyaltyCardDtoPrice != null) __params = __params.set('body.loyaltyCardDto.price', params.bodyLoyaltyCardDtoPrice.toString());
    if (params.bodyLoyaltyCardDtoMaxTicket != null) __params = __params.set('body.loyaltyCardDto.maxTicket', params.bodyLoyaltyCardDtoMaxTicket.toString());
    if (params.bodyLoyaltyCardDtoId != null) __params = __params.set('body.loyaltyCardDto.id', params.bodyLoyaltyCardDtoId.toString());
    if (params.bodyLoyaltyCardDtoExpirationDate != null) __params = __params.set('body.loyaltyCardDto.expirationDate', params.bodyLoyaltyCardDtoExpirationDate.toString());
    if (params.bodyLoyaltyCardDtoDiscount != null) __params = __params.set('body.loyaltyCardDto.discount', params.bodyLoyaltyCardDtoDiscount.toString());
    if (params.bodyId != null) __params = __params.set('body.id', params.bodyId.toString());
    if (params.bodyEmail != null) __params = __params.set('body.email', params.bodyEmail.toString());
    if (params.bodyAge != null) __params = __params.set('body.age', params.bodyAge.toString());
    ...
    return this.http.request<any>(req).pipe(
      ...
      __map((_r) => {
        return _r as __StrictHttpResponse<InfoUserDto>;
      })
    );
  }
  /**
   ...
   * @return OK
   */
  addUsingPOST2(params: UserControllerService.AddUsingPOST2Params): __Observable<InfoUserDto> {
    return this.addUsingPOST2Response(params).pipe(
      __map(_r => _r.body as InfoUserDto)
    );
  }
}
...
module UserControllerService {
  ...
  export interface AddUsingPOST2Params {
    ...
    bodyUsername?: string;
    bodySurname?: string;
    bodySeansDtoSeatCount?: number;
    bodySeansDtoRowNumber?: number;
    bodySeansDtoRoomNumber?: number;
    bodySeansDtoId?: number;
    bodyRoles?: Array<string>;
    bodyReviewDtoId?: number;
    bodyPasswordConfirmation?: string;
    bodyPassword?: string;
    bodyName?: string;
    bodyLoyaltyCardDtoPrice?: number;
    bodyLoyaltyCardDtoMaxTicket?: number;
    bodyLoyaltyCardDtoId?: number;
    bodyLoyaltyCardDtoExpirationDate?: string;
    bodyLoyaltyCardDtoDiscount?: number;
    bodyId?: number;
    bodyEmail?: string;
    bodyAge?: number;
  }
